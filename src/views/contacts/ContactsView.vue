...
<template><div>
  <div class="d-flex align-center mb-4"><h1 class="text-h5 font-weight-bold">Contatos</h1><v-spacer /><v-btn color="primary" variant="outlined" prepend-icon="mdi-plus" @click="router.push('/contacts/new')">Novo contato</v-btn></div>
