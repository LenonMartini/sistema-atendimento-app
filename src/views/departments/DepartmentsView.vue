...
<template><div>
  <div class="d-flex align-center mb-4"><h1 class="text-h5 font-weight-bold">Setores e equipes</h1><v-spacer /><v-btn color="primary" prepend-icon="mdi-plus" @click="router.push('/settings/departments/new')">Novo setor</v-btn></div>
